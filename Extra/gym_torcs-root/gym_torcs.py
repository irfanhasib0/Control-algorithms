...
class TorcsEnv:
    ...
    def __init__(self, vision=False, throttle=False, gear_change=False,jupyter=False):
    ...
    def reset(self, relaunch=False):
        ...
        # Modify here if you use multiple tracks in the environment
        self.client = snakeoil3.Client(p=3101, vision=self.vision,jupyter=self.jupyter)  # Open new UDP in vtorcs
        self.client.MAX_STEPS = np.inf
